  ...
  function myFunction(xml) {
    ...
    for (i = 0; i< title_temp.length; i++) {
      txt += '<div class="border border-primary border-2 rounded mt-2 "><p class="fs-2 text-center fw-bold">' + title_temp[i].childNodes[0].nodeValue + '</p> <br>'
       + '<div class="row"><div class="col-6"><img src="'+ image[i].childNodes[0].nodeValue+ '" class="img-fluid rounded"></div>' + 
       '<div class="col-6"><p class="fs-3" >' + description[i].childNodes[0].nodeValue + '</p></div></div><br></div>';
    }
